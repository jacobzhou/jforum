...
class Admin::SurveysController < Admin::BaseController
  ...
  def notify
    ...
    flash[:success] = "提醒成功" if SurveyNotice.find_or_create_by_noticer_id_and_user_id_and_survey_question_id(current_user.id, survey_user_answer.survey_user_sheet.user_id, survey_user_answer.survey_question_id)
    redirect_to :back
  end
end
