...
Siteconf.defaults[:site_name] = 'Jforum' # 站点名称，如: Jforum
Siteconf.defaults[:welcome_tip] = '欢迎访问<strong>Jforum</strong>' # 网站欢迎语, 支持html标签
Siteconf.defaults[:splash] = '<div class="hero-unit"><h1>Jforum</h1><p>新一代简洁社区软件</p></div>'
Siteconf.defaults[:ga_id] = '' # Google Analytics ID
Siteconf.defaults[:default_search_engine] = 'google' # 默认搜索引擎，可从下面的搜索引擎列表中选择
Siteconf.defaults[:seo_description] = 'Jforum - 新一代简洁社区软件' # SEO 描述
Siteconf.defaults[:short_intro] = '新一代简洁社区软件' # 网站简短介绍, 显示在右侧边栏
Siteconf.defaults[:footer] = '<p>&copy; 2012 Jforum</p>'
Siteconf.defaults[:mobile_footer] = '&copy; 2012 Jforum'
